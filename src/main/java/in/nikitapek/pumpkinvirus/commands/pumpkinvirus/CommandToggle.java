...
import in.nikitapek.pumpkinvirus.commands.CommandPumpkinVirus.PumpkinVirusCommands;
...
public final class CommandToggle extends PlayerOnlyCommand {
    ...
    public CommandToggle(final PumpkinVirusConfigurationContext configurationContext) {
        super(configurationContext, PumpkinVirusCommands.TOGGLE, 0, 1);
